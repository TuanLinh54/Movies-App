...
const loginUser = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        //if user exists compare password with hashed password then user data and token to client
...
const getLikedMovies = asyncHandler(async (req, res) => {
    try {
        ...
        // if user exists send liked movie to client
        if (user) {
...
const addLikedMovies = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (user) {
            //if movie already send error message
...
const deleteLikedMovies = asyncHandler(async (req, res) => {
    try {
        ...
        if (user) {
            user.likedMovies = [];
            await user.save();
            res.json({ message: "All your favorite movies deleted successfully" });
        }
        //else send error message
        else {
            res.status(404);
